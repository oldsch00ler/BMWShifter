...
// import from BMWShifter\arduinoLib\ArduinoJoystickLibrary-master.zip
#include <Joystick.h>
...
String shifter_middle           = "0x0E";
String shifter_middle_move_down = "0x3E";
String shifter_middle_move_up   = "0x1E";
String shifter_side             = "0x7E";
String shifter_side_move_down   = "0x6E";
String shifter_side_move_up     = "0x5E";
...
void setShifterStatus(byte status_code)
{
  ...
  CAN.sendMsgBuf(0x3FD, 0, 4, payload);
